...
// Возможно все таки стоит вынести в хелперы ?
function extendFunctions(type, optionsChainItem) {
	var result = [],
		x, z;
	...
	for (x = arguments.length - 1; x > 0; x--) {
		...
		if (Object.prototype.toString.call(arguments[x][type]) === '[object Array]') {
