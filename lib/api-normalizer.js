...
var nestedNodeTypes = ['models', 'endpoints'], // Возможные типы нод в API
    normalizedAPIDecl;

/**
 * Обработка ноды ненормализованной декларации API, вызывается рекурсивно по
 * мере прохождения по дереву ненормализованной декларации
 * @private
 * @param  {Object} node
 * @param  {String} nodeType
 * @param  {String} parentPath
 * @return {Object} Нормализованное API
 */
...
/**
 * Нормализует описание API, для работы с ним в дальнейшем
 * @param  {Object} APIDecl Ненормализованная декларация API
 * @return {Object}         Нормализованная декларация
 */
